...
//Expenses: Category 1, 2, etc(class). Individual Costs: properties =>
// Select: Monthly or Weekly, Type: Flexible or Fixed, Value/Cost, Weekly/Monthly Spending Goal: 

//Income
//Add Primary Income: 
//Savings Goal per week/month
